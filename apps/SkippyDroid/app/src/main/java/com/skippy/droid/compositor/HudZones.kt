 ...
 * (declared on [com.skippy.droid.layers.FeatureModule]) to decide where the
 ...
 * multi-zone content (e.g. [com.skippy.droid.features.navigation.NavigationModule]
...
enum class HudZone {
     ...
     * Top half: [com.skippy.droid.compositor.ModeSegments] bound to ContextEngine mode.
     * Bottom half: [com.skippy.droid.compositor.RmsGlyph] bound to VoiceEngine.rmsLevel.
     ...
     * Top half: [com.skippy.droid.compositor.VerticalFillBar] bound to phone battery %.
     * Bottom half: [com.skippy.droid.compositor.SignalStack] bound to TransportLayer ping tier.
     * No [androidx.compose.material3.Text]. No icons. Canvas primitives only.
     */
    RightBar,
