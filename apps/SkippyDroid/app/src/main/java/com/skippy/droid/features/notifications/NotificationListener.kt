package com.skippy.droid.features.notifications
 ...
 * TopCenter toast via [com.skippy.droid.compositor.SizeJustifiedText].
 */
class NotificationListener : NotificationListenerService() {

    companion object {
        private const val TAG = "Skippy.NotifListener"
        private const val OWN_PKG = "com.skippy.droid"
    }
