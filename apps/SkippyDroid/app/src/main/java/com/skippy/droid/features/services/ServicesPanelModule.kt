package com.skippy.droid.features.services
...
import com.skippy.droid.compositor.passthrough.AppRegistry
...
class ServicesPanelModule(
    ...
    override val id = "services_panel"
                ...
                snapshot.forEach { view ->
                    ...
                    Text(
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                Log.i("Skippy.Services", "tile tapped: ${view.id}")
