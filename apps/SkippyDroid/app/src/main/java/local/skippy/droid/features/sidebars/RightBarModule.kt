...
import local.skippy.droid.compositor.SignalStack
import local.skippy.droid.compositor.VerticalFillBar
 ...
 *
 * ── Coexistence note ──────────────────────────────────────────────────────
 * The existing text-based [local.skippy.droid.features.battery.BatteryModule]
...
class RightBarModule(
    ...
    override val id = "local.skippy.rightbar"
